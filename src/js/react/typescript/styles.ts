...
export type StyleClassKey<X> = X extends (theme:Theme)=>Record<infer P,CreateCSSProperties<{}> | ((props: infer Props) => CreateCSSProperties<infer Props>)> ? P : never;//withStyles HOC
