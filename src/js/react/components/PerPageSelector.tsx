...
export interface PerPageSelectorProps extends StandardProps<{},PerPageSelectorClassKey> {
    selected?:number,
    before?:ReactNode
    after?:ReactNode
    allowed?:number[],
    ...
    return (
        <div className={classes.root}>
            ...
            <AppSelect value={{
                ...
                value: rest.selected
            }} isSearchable={false} onChange={(val:SimpleOption)=>onChange(val.value)} options={allowed.map(item=>({
                label: item.toString(),
                value: item
            }))} />
            {after}
