...
export interface ImageCapturerProps {
}
 ...
 */
export class ImageCapturer extends React.PureComponent<ImageCapturerProps, State> {
    ...
    componentDidMount() {
        navigator.mediaDevices.getUserMedia({
            video: {
                height: {
                    min: 300, max: 850, ideal: 600
                },
                width: {
                    min: 300, max: 850, ideal: 800
                }
            }
        }).then((stream)=>{
            let found = false;
