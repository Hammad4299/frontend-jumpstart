...
const Rectangle = ({ innerProps }: PathInjectedProps) => {
    return <rect width="351.7" height="93" {...innerProps} />
}

const Parallelogram = ({ innerProps }: PathInjectedProps) => {
    return (
        <polygon
            points="318.3,91.5 2.1,91.5 33.4,1.7 349.6,1.7 "
            {...innerProps}
        />
    )
}
...
const Octagon = ({ innerProps }: PathInjectedProps) => {
    return (
        <path
            d="M22.5,91.5h306.7c8.2-8.2,12.8-12.8,21-21v-48c-8.2-8.2-12.8-12.8-21-21H22.5
	c-8.2,8.2-12.8,12.8-21,21v48C9.7,78.7,14.3,83.3,22.5,91.5z"
            {...innerProps}
        />
    )
}
...
const CurvedBorders = ({ innerProps }: PathInjectedProps) => {
    return (
        <path
            d="M20.8,91.4H331c10.4,0,18.9-8.5,18.9-18.9v-52c0-10.4-8.5-18.9-18.9-18.9H20.8
	C10.3,1.6,1.9,10,1.9,20.5v52C1.9,82.9,10.3,91.4,20.8,91.4z"
            {...innerProps}
        />
    )
}
...
const RoundedBorders = ({ innerProps }: PathInjectedProps) => {
    return (
        <path
            d="M46.8,91.4H305c24.8,0,44.9-20.1,44.9-44.9v0c0-24.8-20.1-44.9-44.9-44.9H46.8
	C22,1.6,1.9,21.7,1.9,46.5v0C1.9,71.3,22,91.4,46.8,91.4z"
            {...innerProps}
        />
    )
}
...
function ShapedButton(props: StyledProps) {
    const defaultedProps: StyledProps = defaultsDeep({}, props, {
    ...
    const textAlignmentProps = getAlignment(
        textHorizontalAlignment,
        textVerticalAlignment
    )
    return (
