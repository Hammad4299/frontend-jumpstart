...
const styles = (theme: Theme) => {
    const buttonSetting =
        theme.custom.kiosk.setting[ThemeSettingIdentifier.setting_button]
    return createStyles({
        invisible: {
            visibility: "hidden",
        },
        ...
        theme: {
                ...
                "& .hg-row": {
                    ...
                    "& $spaceButton": {
                        ...
                        backgroundColor: toRGBAString(
                            buttonSetting.secondary.background
                        ),
                        "& span": {
                            transform: "scale(2,1)",
                        },
            ...
            "& .hg-row .hg-button": {
                ...
                "&$clearButton": {
                    ...
                    backgroundColor: toRGBAString(
                        buttonSetting.cancel.background
                    ),
                },
                "&$acceptButton": {
                    color: toRGBAString(buttonSetting.accept.color),
                    backgroundColor: toRGBAString(
                        buttonSetting.accept.background
                    ),
                },
            },
        },
            ...
            return (
                <SimpleKeyboard
                    ...
                    layout={{
                        ...
                        number: ["1 2 3", "4 5 6", "7 8 9", "{none} 0 {empty}"],
                    }}
                    display={{
                        "{empty}": "X",
                        "{enter}": "ENTER",
                    ...
                    buttonTheme={[
                        ...
                        },
                        {
                            class: classes.round,
                            buttons:
                                "1 2 3 4 5 6 7 8 9 0 {empty} Q W E R T Y U I O P A S D F G H J K L Z X C V B N M",
                        },
                        {
