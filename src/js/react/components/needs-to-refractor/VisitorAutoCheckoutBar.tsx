...
type StyledProps = VisitorAutoCheckoutBarProps & WithStyles<VisitorAutoCheckoutBarClassKeys>
...
export const VisitorAutoCheckoutBar = decorator(
    class extends React.PureComponent<StyledProps, State> {
        ...
        protected getColor() {
            ...
            ].sort((p,c)=>p.atleast>c.atleast ? -1 : p.atleast === c.atleast ? 0 : 1);
        ...
        protected getRemaining() {
            const now = parseInt(moment().utc().format('X'));
