        ...
        <Paper className={paper} elevation={0}>
            <div className={tableTopToolbar}>
                <div className={perPageContainer}>
                    {detail ? (
                        <PerPageSelector
                            selected={detail.per_page}
                            {...perPageProps}
                        />
                    ) : null}
                </div>
                <div className={rightContainer}>{rightToolContainer}</div>
            </div>
            <Table
                {...{ border: 1 }}
                className={table}
            ...
            <div className={tableTopToolbar}>
                <Typography className={perPageContainer}>
                    {detail && paginationInfo.total > 0
                        ? `Showing ${detail.startingItem} to ${detail.endingItem} of ${detail.total} entries`
                        : null}
                </Typography>
                <div>
