...
interface NotificationTemplateDialogProps {
    ...
    onClose: (
        notificationTemplate?: NotificationTemplateCreateUpdateRequestParameters
    ) => void
}
...
class NotificationTemplateDialog extends React.PureComponent<
    StyledProps,
    State
> {
    constructor(props: StyledProps) {
        ...
        } = this.props.notificationTemplate
            ? this.props.notificationTemplate
            : {}
    ...
    protected createUpdate(event: React.MouseEvent<HTMLInputElement>) {
        ...
        onClose({
            ...
            id: this.isUpdate()
                ? this.props.notificationTemplate.id
                : undefined,
    ...
    protected handleTextInputChange(
                            ...
                            <Grid container>
                                <Grid item container lg={3} md={4} xs={6}>
                                    <TextFieldWithState
                                        ...
                                        errorInfo={fieldsState.getError("name")}
                    ...
                    <div>
                        <FormGroup>
                            <EmailTemplateControl
                                ...
                                fieldState={this.props.fieldsState}
                                onChange={temp => {
                                    this.setState({
                                        value: {
                                            ...this.state.value,
...
type StyledEmailTemplateControlProps = EmailTemplateControlProps &
